...
def main() -> None:
    ...
    print("Zero-cost deployment contract verified: Render static frontend + Render free API + Supabase; authenticated sealed database credential, HTTPS transactional email, no web-runtime DDL, no Google control-plane/registry wiring, and explicitly gated data mutations.")
