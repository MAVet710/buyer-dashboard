...
def test_production_fastapi_graph_registers_supplier_surfaces():
    from backend.app.main import app

    paths = {str(getattr(route, "path", "")) for route in app.routes}
    expected = {
        "/api/v1/supplier-portal/access",
        "/api/v1/supplier-portal/offers",
        "/api/v1/supplier-portal/offers/{offer_id}/review",
        "/api/v1/commerce-portal/{token}/offers",
        "/api/v1/commerce-portal/{token}/offers/{offer_id}/revisions",
        "/api/v1/commerce-portal/{token}/offers/{offer_id}/withdraw",
    }
