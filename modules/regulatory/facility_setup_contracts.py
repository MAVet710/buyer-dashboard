...
FACILITY_SETUP_ACTIONS: dict[str, FacilitySetupActionSpec] = {
    ...
    "processing_job_type_create": FacilitySetupActionSpec("processing_job_type_create", "Create production process", "processing_job_types", "POST", "processing/v2/jobtypes", "Manage Processing Jobs", "processing_job_type"),
    "processing_job_type_update": FacilitySetupActionSpec("processing_job_type_update", "Edit production process", "processing_job_types", "PUT", "processing/v2/jobtypes", "Manage Processing Jobs", "processing_job_type"),
    "processing_job_type_discontinue": FacilitySetupActionSpec("processing_job_type_discontinue", "Discontinue production process", "processing_job_types", "DELETE", "processing/v2/jobtypes/{id}", "Manage Processing Jobs", "processing_job_type"),
    "additive_template_create": FacilitySetupActionSpec("additive_template_create", "Create cultivation program", "additive_templates", "POST", "additivestemplates/v2/", "Manage Plants", "additive_template"),
    "additive_template_update": FacilitySetupActionSpec("additive_template_update", "Edit cultivation program", "additive_templates", "PUT", "additivestemplates/v2/", "Manage Plants", "additive_template"),
    "driver_create": FacilitySetupActionSpec("driver_create", "Create transport driver", "drivers", "POST", "transporters/v2/drivers", "Manage Transfers", "driver"),
    "driver_update": FacilitySetupActionSpec("driver_update", "Edit transport driver", "drivers", "PUT", "transporters/v2/drivers", "Manage Transfers", "driver"),
    "driver_discontinue": FacilitySetupActionSpec("driver_discontinue", "Discontinue transport driver", "drivers", "DELETE", "transporters/v2/drivers/{id}", "Manage Transfers", "driver"),
    "vehicle_create": FacilitySetupActionSpec("vehicle_create", "Create transport vehicle", "vehicles", "POST", "transporters/v2/vehicles", "Manage Transfers", "vehicle"),
    "vehicle_update": FacilitySetupActionSpec("vehicle_update", "Edit transport vehicle", "vehicles", "PUT", "transporters/v2/vehicles", "Manage Transfers", "vehicle"),
    "vehicle_discontinue": FacilitySetupActionSpec("vehicle_discontinue", "Discontinue transport vehicle", "vehicles", "DELETE", "transporters/v2/vehicles/{id}", "Manage Transfers", "vehicle"),
}
