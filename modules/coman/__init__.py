...
class ComanRepository(_BaseComanRepository):
    """Preserve the Co-Man API while preventing cross-workspace over-commitment."""
...
# Any existing `from modules.coman.repository import ComanRepository` import receives
# the guarded implementation after package initialization, preserving legacy callers.
