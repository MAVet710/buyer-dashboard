...
export function AuthGate({ children }: PropsWithChildren) {
  ...
  if (!session) return <div className="auth-screen"><div className="auth-stage">
    <section className="auth-intro">
      <div className="brand hero-brand"><span>DL</span><div><strong>DoobieLogic</strong><small>Operations Intelligence</small></div></div>
      <h1>Keep shelves stocked, production moving, and chaos off the schedule.</h1>
      <p>DoobieLogic connects buying, inventory, compliance, production, Co-Man, and fulfillment—so your team stays profitable and nobody has to ask which spreadsheet is the right one.</p>
      <div className="auth-proof"><span>Buy smarter. Stock cleaner.</span><span>Count inventory from the floor</span><span>Plan Co-Man without guesswork</span><span>Reports leadership will actually read</span></div>
    </section>
